declare type mxCodecConstructor = new(document: XMLDocument | null) => mxCodec;
...
// };
   ...
   */
  document: XMLDocument | null; //null
...
// };
   ...
   */
  getElementById(id: string): object | null | undefined;
...
// };
   ...
   */
  encodeCell(cell: mxCell, node, includeChildren?: boolean): void;
